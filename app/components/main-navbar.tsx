import { Bell, Dog, Home, PawPrint, UserRound } from "lucide-react";
...
export function MainNavbar() {
  return (
    <nav className="flex w-full flex-col gap-4 rounded-xl border border-slate-700/50 bg-slate-950/40 px-4 py-3 shadow-2xl shadow-cyan-950/20 backdrop-blur-md sm:px-6 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <Show when="signed-in">
            <div className="rounded-lg border border-slate-700/70 bg-slate-900/60 p-1">
              <UserButton />
            </div>
          </Show>
        </div>
